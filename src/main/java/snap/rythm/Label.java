...
public class Label extends JavaTagBase
{
  ...
  protected void call(__ParameterList params, __Body body)
  {
    ...
    if (paramMap.size() > 0)
    {
      ...
      if (o == null)
        throw new SnapException("@label missing 'field' argument. You must specify the field in the form");
      name = o.toString();
    ...
    // params were passed by position
    {
      ...
      if (params.size() > 2)
        log.warn("@label in form: '" + form.toString() + "', positional parameter two and after ignored.");
